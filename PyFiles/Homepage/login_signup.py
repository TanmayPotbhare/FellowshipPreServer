    ...
    def login():
        ...
        if request.method == 'POST':
            ...
            if user:
                ...
                if not user_password.startswith("$2b$"):
                    if password == user_password:
                        ...
                        if is_withdrawn(email):
                            ...
                            # Set a session flag indicating a successful login
                            session['logged_in_from_login'] = True
                            return redirect(url_for('viewform.main_page'))
                ...
                return render_template('Homepage/login.html', error=flash, language=language,
