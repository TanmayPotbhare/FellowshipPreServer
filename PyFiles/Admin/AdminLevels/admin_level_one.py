...
def adminlevelone_auth(app, mail):
    ...
    def admin_level_1():
        ...
        cursor.close()
        cnx.close()
        return render_template('Admin/AdminLevels/AdminOne/admin_level_one.html', data=data)
    ...
    def accepted_students_level1():
        ...
        return render_template('Admin/AdminLevels/AdminOne/accepted_students_level1.html', result=result)
