...
withdrawed_application_blueprint = Blueprint('withdrawed_application', __name__)


def withdrawed_application_auth(app):
    ...
    @withdrawed_application_blueprint.route('/withdrawed_application_admin', methods=['GET', 'POST'])
    def withdrawed_application_admin():
        ...
        cursor.close()
        cnx.close()
        return render_template('Admin/withdrawed_application_admin.html', result_set=result_set, var=var,
