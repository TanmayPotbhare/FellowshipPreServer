    ...
    def hra_reports():
        ...
        cursor.execute("""
            SELECT first_name, last_name, phd_registration_date, rent_agreement1, rent_agreement2,
                   rent_agreement3, rent_agreement4, rent_agreement5
        ...
        reports = {f"rent_agreement{i}": user_data.get(f"rent_agreement{i}") for i in range(1, 6)}
        joining_date = records.get('joining_date')
