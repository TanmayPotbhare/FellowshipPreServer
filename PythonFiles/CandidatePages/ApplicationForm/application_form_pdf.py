...
def app_pdf_auth(app):
    ...
    def generate_pdf_with_styling(data, filename):
        class PDF(FPDF):
            def header(self):
                ...
                self.cell(0, 10, 'Application Form', align='C', ln=True)
        ...
        pdf.cell(0, 10, 'Name: John Doe', ln=True)
        pdf.cell(0, 10, 'Email: john.doe@example.com', ln=True)
        pdf.cell(0, 10, 'Year: 2022', ln=True)
    ...
    #
    #     # Personal Details
    #     col_widths = [60, 60, 60]  # 3 columns with equal width
    #
    #     # Header row (Key1, Key2, Key3)
    #     pdf.cell(col_widths[0], 10, "Key", border=1, align='C')
    #     pdf.cell(col_widths[1], 10, "Key", border=1, align='C')
    #     pdf.cell(col_widths[2], 10, "Key", border=1, ln=True, align='C')
    #
    #     # Set font for table data
    #     pdf.set_font("Arial", size=10)
    #
    #     # Loop through the dictionary and create rows of 3 keys per row
    #     items = list(personal_details.items())  # Convert dictionary to list
    #     for i in range(0, len(items), 3):
    #         # Create a row for 3 keys and values
    #         for j in range(3):
    #             if i + j < len(items):  # Check if the item exists
    #                 key, value = items[i + j]
    #                 pdf.cell(col_widths[j], 10, str(key), border=1, align='C')
    #                 pdf.cell(col_widths[j], 10, str(value), border=1, align='C')
    #             else:
    #                 pdf.cell(col_widths[j], 10, "", border=1, align='C')
    #                 pdf.cell(col_widths[j], 10, "", border=1, align='C')
    ...
    #     pdf.cell(0, 10, "Place:" + ' ' + str(data['city']) + ', ' + str(data['state']), ln=True)
    #
